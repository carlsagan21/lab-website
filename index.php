...
<div class="site-content">
  ...
  <div class="hero">
    <ul class="slides">
      <li data-bg-image="images/slider-1.jpg">
        <div class="container">
          <div class="slide-content">
            <h2 class="slide-title">index1</h2>
            <p>index2</p>
      ...
      <li data-bg-image="images/slider-2.jpg">
        <div class="container">
          <div class="slide-content">
            <h2 class="slide-title">index3</h2>
            <p>index4</p>
            <!--<a href="#" class="button">See details</a>-->
          </div>
        </div>
      ...
      <li data-bg-image="images/slider-3.jpg">
        <div class="container">
          <div class="slide-content">
            <h2 class="slide-title">index5</h2>
            <p>index6</p>
            <!--<a href="#" class="button">See details</a>-->
          </div>
        </div>
  ...
  <main class="main-content">
    ...
    <!--</div> &lt;!&ndash; .fullwidth-block &ndash;&gt;-->

    <div class="fullwidth-block" data-bg-color="#edf2f4">
      <div class="container">
        <div class="row">
          <div class="col-md-8">
            <h2 class="section-title">middle-title</h2>
            <p>middle-content</p>
          </div>
          <div class="col-md-4">
    ...
    <div class="fullwidth-block cta" data-bg-image="images/cta-bg.jpg">
      <div class="container">
        <h2 class="cta-title">bottom-title</h2>
        <p>bottom-content</p>
        <!--<a href="#" class="button">See details</a>-->
      </div>
    </div>
